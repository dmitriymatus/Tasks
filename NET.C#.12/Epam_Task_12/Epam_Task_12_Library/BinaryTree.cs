...
namespace Epam_Task_12_Library
{
   ...
   public class BinaryTree<T> : ICollection<T> where T : IComparable
   {
      ...
      /// <summary>
      /// Своство для получения/задания корня дерева
      /// </summary>
      ...
      /// <summary>
      /// Метод для перебора всех элементов
      /// </summary>
      /// <returns>Возвращает объект IEnumerator<T> </returns>
